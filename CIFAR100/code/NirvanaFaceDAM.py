...
def main(args):
    ...
    # lfw, lfw_issame = get_val_data('./data')
    # lfw, lfw_issame = get_val_data('./data')
    lfw, cfp_ff, cfp_fp, agedb_30, calfw, cplfw, lfw_issame, cfp_ff_issame, cfp_fp_issame, agedb_30_issame, calfw_issame, cplfw_issame = get_val_data('/home/mlcv/CevikalpPy/deep_simplex_classifier/data')
