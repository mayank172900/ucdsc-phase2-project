...
def train_one_epoch(model,centerloss, optimizer, data_loader, device, epoch, args):
    ...
    utils.mkdir('/home/mlcv/CevikalpPy/nirvana/figures_simplex_hinge_loss')
    ax.figure.savefig(os.path.join("figures_simplex_hinge_loss","fig_new_%d.png"%epoch))
    plt.close('all')
...
def main(args):
    ...
    # default dsc loss
    centerloss = NirvanaHinge(args.num_classes,args.feat_dim,True,device, Expand=args.Expand)
