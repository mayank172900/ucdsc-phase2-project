splits_2020 = {
    ...
    'pathmnist': [
        {'known': [0, 1, 2, 3, 4, 5], 'unknown': [6, 7, 8]},
        {'known': [0, 1, 2, 6, 7, 8], 'unknown': [3, 4, 5]},
        {'known': [0, 3, 4, 5, 7, 8], 'unknown': [1, 2, 6]},
        {'known': [1, 2, 3, 4, 6, 8], 'unknown': [0, 5, 7]},
        {'known': [0, 2, 4, 5, 6, 7], 'unknown': [1, 3, 8]}
    ],
    'asc': [
